...
class MyMapPage extends StatefulWidget {
  ...
  final double map_lng;
  final double zoom;
  final String address;
  MyMapPage({this.map_lat, this.map_lng, this.zoom, this.address});
  @override
  ...
  List<Widget> _buildAddButtons() => [
        ...
        FloatingActionButton(
          ...
          onPressed: () {
            ...
            GoogleMap.of(_key).addMarkerRaw(
              GeoCoord(widget.map_lat, widget.map_lng),
          ...
          children: <Widget>[
            Positioned.fill(
              child: GoogleMap(
                ...
                initialPosition:
                    GeoCoord(widget.map_lat, widget.map_lng), // Los Angeles, CA
